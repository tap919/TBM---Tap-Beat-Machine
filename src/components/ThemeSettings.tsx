  ...
  return (
    <div className="h-full flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[13px] text-neutral-500 font-mono uppercase">Personalize your workstation</p>
          </div>
        </div>
        <button 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Preset Themes */}
        <div className="bg-neutral-900 rounded-xl border border-neutral-800 p-6 flex flex-col gap-4 vignette">
        ...
        <div className="bg-neutral-900 rounded-xl border border-neutral-800 p-6 flex flex-col gap-4 vignette noise-texture relative">
          <div className="flex items-center justify-between">
            <span className="text-[13px] font-bold text-neutral-500 uppercase tracking-widest">Custom Theme Creator</span>
            <Pipette size={14} className="text-neutral-600" />
          </div>
          
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-2">
              <label className="text-[13px] text-neutral-500 uppercase font-bold">Primary Accent</label>
            ...
            <div className="flex flex-col gap-2">
              <label className="text-[13px] text-neutral-500 uppercase font-bold">Background Color</label>
              <div className="flex gap-2">
                <input 
                  type="color" 
            ...
            <div className="flex flex-col gap-2">
              <label className="text-[13px] text-neutral-500 uppercase font-bold">Surface Color</label>
              <div className="flex gap-2">
                <input 
                  type="color" 
            ...
            <div className="flex flex-col gap-2">
              <label className="text-[13px] text-neutral-500 uppercase font-bold">Border Color</label>
              <div className="flex gap-2">
                <input 
                  type="color" 
      ...
      {/* Preview Area */}
      <div className="flex-1 bg-neutral-900 rounded-xl border border-neutral-800 p-6 flex flex-col gap-4 overflow-hidden vignette">
        <span className="text-[13px] font-bold text-neutral-500 uppercase tracking-widest">UI Preview</span>
        <div className="flex-1 rounded-lg overflow-hidden border border-neutral-800 flex flex-col" style={{ backgroundColor: currentTheme.bg }}>
          <div className="h-10 border-b flex items-center px-4 justify-between relative edge-glow-bottom" style={{ backgroundColor: currentTheme.surface, borderColor: currentTheme.border }}>
            <div className="flex gap-2">
              <div className="w-2 h-2 rounded-full dot-glow" style={{ backgroundColor: currentTheme.primary }}></div>
